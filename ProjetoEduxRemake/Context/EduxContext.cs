    ...
    public class EduxContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
                optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-LOT7QKV\SQLEXPRESS2;Initial Catalog=NewProjetoEduxRemake;Persist Security Info=True;User ID=sa;Password=sa132");
